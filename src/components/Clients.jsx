...
export default function Clients() {
  ...
  return (
    <section style={{ padding: '90px 0', background: '#12121a', overflow: 'hidden' }}>
      ...
      <style>{`
        ...
        .client-card { flex: 0 0 auto; width: 170px; height: 100px; background: #fff; border-radius: 14px; display: flex; align-items: center; justify-content: center; padding: 20px; }
